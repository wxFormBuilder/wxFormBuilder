...
BEGIN_EVENT_TABLE( MainFrame, wxFrame )
	...
	EVT_TOOL( ID_SAVE_TOOL, MainFrame::_wxFB_OnFileSave )
...
BEGIN_EVENT_TABLE( CommonPanel, wxPanel )
	...
	EVT_TEXT( ID_COMBOBOX, CommonPanel::_wxFB_OnText )
	EVT_TEXT_ENTER( ID_COMBOBOX, CommonPanel::_wxFB_OnTextEnter )
...
BEGIN_EVENT_TABLE( AdditionalPanel, wxPanel )
	EVT_CALENDAR( wxID_ANY, AdditionalPanel::_wxFB_OnCalendar )
	EVT_CALENDAR_DAY( wxID_ANY, AdditionalPanel::_wxFB_OnCalendarDay )
	EVT_CALENDAR_MONTH( wxID_ANY, AdditionalPanel::_wxFB_OnCalendarMonth )
	EVT_CALENDAR_SEL_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnCalendarSelChanged )
	EVT_CALENDAR_WEEKDAY_CLICKED( wxID_ANY, AdditionalPanel::_wxFB_OnCalendarWeekDayClicked )
	EVT_CALENDAR_YEAR( wxID_ANY, AdditionalPanel::_wxFB_OnCalendarYear )
	EVT_DATE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnDateChanged )
	EVT_HTML_CELL_CLICKED( wxID_ANY, AdditionalPanel::_wxFB_OnHtmlCellClicked )
	EVT_HTML_CELL_HOVER( wxID_ANY, AdditionalPanel::_wxFB_OnHtmlCellHover )
	EVT_HTML_LINK_CLICKED( wxID_ANY, AdditionalPanel::_wxFB_OnHtmlLinkClicked )
	EVT_TREE_BEGIN_DRAG( wxID_ANY, AdditionalPanel::_wxFB_OnTreeBeginDrag )
	EVT_TREE_END_DRAG( wxID_ANY, AdditionalPanel::_wxFB_OnTreeEndDrag )
	EVT_TREE_END_LABEL_EDIT( wxID_ANY, AdditionalPanel::_wxFB_OnTreeEndLabelEdit )
	EVT_TREE_GET_INFO( wxID_ANY, AdditionalPanel::_wxFB_OnTreeGetInfo )
	EVT_TREE_ITEM_ACTIVATED( wxID_ANY, AdditionalPanel::_wxFB_OnTreeItemActivate )
	EVT_TREE_ITEM_COLLAPSING( wxID_ANY, AdditionalPanel::_wxFB_OnTreeItemCollapsing )
	EVT_TREE_ITEM_EXPANDING( wxID_ANY, AdditionalPanel::_wxFB_OnTreeItemExpanding )
	EVT_TREE_ITEM_GETTOOLTIP( wxID_ANY, AdditionalPanel::_wxFB_OnTreeItemGetTooltip )
	EVT_TREE_ITEM_MIDDLE_CLICK( wxID_ANY, AdditionalPanel::_wxFB_OnTreeItemMiddle )
	EVT_TREE_SEL_CHANGING( wxID_ANY, AdditionalPanel::_wxFB_SelChanging )
	EVT_TREE_STATE_IMAGE_CLICK( wxID_ANY, AdditionalPanel::_wxFB_OnTreeStateImageClick )
	EVT_RADIOBUTTON( wxID_ANY, AdditionalPanel::_wxFB_OnRadioButton )
	EVT_TOGGLEBUTTON( wxID_ANY, AdditionalPanel::_wxFB_OnToggleButton )
	EVT_COMMAND_SCROLL_DOWN( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollBottom )
	EVT_COMMAND_SCROLL_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollChanged )
	EVT_COMMAND_SCROLL_LINEUP( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollUp )
	EVT_COMMAND_SCROLL_PAGEUP( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollPageUp )
	EVT_COMMAND_SCROLL_THUMBRELEASE( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollThumbRelease )
	EVT_COMMAND_SCROLL_THUMBTRACK( wxID_ANY, AdditionalPanel::_wxFB_OnCmdScrollThumbTrack )
	EVT_SCROLL( AdditionalPanel::_wxFB_OnScroll )
	EVT_SCROLL_LINEDOWN( AdditionalPanel::_wxFB_OnScrollDown )
	EVT_SCROLL_PAGEDOWN( AdditionalPanel::_wxFB_OnScrollPageDown )
	EVT_SCROLL_THUMBRELEASE( AdditionalPanel::_wxFB_OnScrollThumbRelease )
	EVT_SCROLL_TOP( AdditionalPanel::_wxFB_OnScrollTop )
	EVT_SPINCTRL( wxID_ANY, AdditionalPanel::_wxFB_OnSpinCtrl )
	EVT_TEXT( wxID_ANY, AdditionalPanel::_wxFB_OnSpinCtrlText )
	EVT_SPIN( wxID_ANY, AdditionalPanel::_wxFB_OnSpin )
	EVT_SPIN_DOWN( wxID_ANY, AdditionalPanel::_wxFB_OnSpinDown )
	EVT_SPIN_UP( wxID_ANY, AdditionalPanel::_wxFB_OnSpinUp )
	EVT_SPLITTER_DCLICK( wxID_ANY, AdditionalPanel::_wxFB_OnSplitterDClick )
	EVT_SPLITTER_SASH_POS_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnSplitterSashPosChanged )
	EVT_SPLITTER_SASH_POS_CHANGING( wxID_ANY, AdditionalPanel::_wxFB_OnSpliterSashPosChanging )
	EVT_SPLITTER_UNSPLIT( wxID_ANY, AdditionalPanel::_wxFB_OnSplitterUnsplit )
	...
	EVT_NOTEBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnNotebookPageChanged )
	EVT_NOTEBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnNotebookPageChanging )
	EVT_LISTBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnListbookPageChanged )
	EVT_LISTBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnListbookPageChanging )
	EVT_CHOICEBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnChoicebookPageChanged )
	EVT_CHOICEBOOK_PAGE_CHANGED( wxID_ANY, AdditionalPanel::_wxFB_OnChoicebookPageChanging )
END_EVENT_TABLE()
