...
FBSettings::FBSettings( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_idBox = new wxCheckBox( m_panel5, ID_M_IDBOX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer17->Add( m_idBox, 1, wxALL, 5 );
	
	m_handlerBox = new wxCheckBox( m_panel5, ID_M_HANDLERBOX, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer17->Add( m_handlerBox, 1, wxALL, 5 );
	...
	bSizer15->Add( m_staticText3, 1, wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	m_staticText1 = new wxStaticText( m_panel5, wxID_ANY, wxT("Handler Name"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText1->Wrap( -1 );
	bSizer15->Add( m_staticText1, 1, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT, 5 );
	...
	m_textCtrl2 = new wxTextCtrl( m_panel5, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer14->Add( m_textCtrl2, 1, wxALL|wxEXPAND, 5 );
	
	m_textCtrl1 = new wxTextCtrl( m_panel5, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	bSizer14->Add( m_textCtrl1, 1, wxALL|wxEXPAND, 5 );
	...
	m_staticText4 = new wxStaticText( m_panel5, wxID_ANY, wxT("identifiers = <name> <event_type>\n"), wxDefaultPosition, wxDefaultSize, 0 );
