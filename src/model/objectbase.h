...
public:
    EventInfo(const wxString& name, const wxString& eventClass, const wxString& defValue, const wxString& description);
...
public:
    ...
    void ChangeDefaultValue(const wxString& value) { m_info->m_def_value = value; }
