...
wxDECLARE_EVENT(wxEVT_FB_CODE_GENERATION_TO_FILES, wxFBEvent);
...
#define EVT_FB_CODE_GENERATION_TO_FILES(fn) wx__DECLARE_EVT0(wxEVT_FB_CODE_GENERATION_TO_FILES, wxFBEventHandler(fn))
