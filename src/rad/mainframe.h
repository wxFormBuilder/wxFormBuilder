 ...
 */
enum { wxFB_DEFAULT_GUI, wxFB_DOCKABLE_GUI, wxFB_CLASSIC_GUI, wxFB_WIDE_GUI };
...
public:
    MainFrame(
      wxWindow* parent, int id = wxID_ANY, int style = wxFB_DEFAULT_GUI, wxPoint pos = wxDefaultPosition,
    ...
    wxMenu* CreateSubmenuComponents(PObjectPackage pkg);
